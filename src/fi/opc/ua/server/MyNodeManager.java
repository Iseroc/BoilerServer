...
public class MyNodeManager extends NodeManagerUaNode {
	...
	*/
	...
	private void createBoilerAddressSpace(int ns, UaType baseObjectType) throws StatusException
	{
		...
		//FT1001
		UaObjectNode ft2 = createNode(ns, "FT1002", pipeType, pipe2);
	...
	private void createMyEnumNode() throws StatusException {
		...
		NodeId myEnumObjectId = new NodeId(this.getNamespaceIndex(),
				"MyEnumObject");
		PlainVariable<MyEnumType> myEnumVariable = new PlainVariable<MyEnumType>(
	...
	private void createMyEventType() throws StatusException {
		...
		PlainVariable<Integer> myVariable = new PlainVariable<Integer>(this,
				myVariableId, MyEventType.MY_VARIABLE_NAME,
				LocalizedText.NO_LOCALE);
		...
		PlainProperty<Integer> myProperty = new PlainProperty<Integer>(this,
				myPropertyId, MyEventType.MY_PROPERTY_NAME,
				LocalizedText.NO_LOCALE);
